    ...
    <div className="px-4 xl:px-6">
      ...
      <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] dark:border-stroke-dark md:items-center">
        ...
        <div className="flex items-center gap-2">
          <button className="dark:hover:t text-gray-500 hover:text-gray-600 dark:text-neutral-500 dark:hover:text-gray-300">
          ...
          <div className="relative">
            <Grid3X3 className="dark:text-neutral absolute left-3 top-2 h-4 w-4 text-gray-400 dark:text-neutral-500" />
            <input
              type="text"
